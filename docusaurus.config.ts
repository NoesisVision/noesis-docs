...
const config: Config = {
  ...
  url: 'https://noesisvision.github.io',
  ...
  organizationName: 'noesisvision', // Usually your GitHub org/user name.
  projectName: 'noesis-docs', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Noesis Vision. Built with Docusaurus.`,
    },
    prism: {
